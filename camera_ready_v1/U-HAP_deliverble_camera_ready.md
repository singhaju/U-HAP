...
the benefit of compile-time hash consing over OPA's
...
This paper presented U-HAP, a compilation-driven authorization framework
that unifies RBAC, ABAC, ACL, and explicit deny policies into a single
Kubernetes authorization mechanism. By shifting policy reasoning to an
offline compilation phase, U-HAP eliminates repeated runtime policy
scanning and enables efficient authorization through indexed artifacts
and lightweight verification. Experimental results demonstrate that U-HAP maintains stable low latency
under increasing namespace and policy complexity, consistently
outperforming conventional SSO-based approaches that rely on repeated
policy evaluation. Compilation and decision caching provide complementary
performance benefits, while per-policy analysis confirms improved
efficiency across RBAC, ABAC, and ACL models. U-HAP also achieves faster
policy-update processing with a compact compiled-state footprint,
demonstrating the practicality of the framework for dynamic Kubernetes
environments. Future work includes supporting cluster-wide and cross-namespace
policies, enabling incremental recompilation for dynamic updates, and
integrating U-HAP with production-grade authorization engines for
large-scale multi-cluster deployment and evaluation.
%% ==========================================================================
...
An empirical study,''
\emph{ACM Trans.\ Softw.\ Eng.\ Methodol.}, vol.~32, no.~4, art.\,no.\,99, 2023, doi: 10.1145/3579639.
...
in \emph{Proc.\ ACM CCS}, 2023, pp.~3048--3062, doi: 10.1145/3576915.3623121.
...
\emph{Sensors}, vol.~23, no.~7, art.\,no.\,3413, 2023, doi: 10.3390/s23073413.
...
analysis,''
in \emph{Proc.\ DBSec}, 2024, pp.~3--23, doi: 10.1007/978-3-031-65172-4\_1.

\bibitem{b9}
Z.~Mori\'{c}, V.~Daki\'{c}, and T.~\v{C}avala,
``Security hardening and compliance assessment of Kubernetes control
plane and workloads,''
\emph{J.\ Cybersec.\ Privacy}, vol.~5, no.\,2, art.\,no.\,30, 2025, doi: 10.3390/jcp5020030.

\bibitem{b10}
Y.~Gu, X.~Tan, Y.~Zhang, S.~Gao, and M.~Yang,
``EPScan: Automated detection of excessive RBAC permissions in Kubernetes applications,''
in \emph{Proc.\ 2025 IEEE Symp.\ Security and Privacy (SP)}, 2025, pp.~3199--3217, doi: 10.1109/SP61157.2025.00011.
...
NIST SP 800-207A, 2023, doi: 10.6028/NIST.SP.800-207A.

\bibitem{b13}
H.~Kermabon-Bobinnec \emph{et~al.},
``{PerfSPEC}: Performance profiling-based proactive security policy
enforcement for containers,''
\emph{IEEE Trans.\ Dependable Secure Comput.}, vol.~22, no.~2, pp.~919--938, 2025, doi: 10.1109/TDSC.2024.3420712.

\bibitem{b14}
S.~Kern, T.~Baumer, S.~Groll, L.~Fuchs, and G.~Pernul,
``Optimization of access control policies,''
\emph{J.\ Inf.\ Secur.\ Appl.}, vol.~70, art.\,no.\,103301, 2022, doi: 10.1016/j.jisa.2022.103301.

\bibitem{b15}
A.~X.~Liu, F.~Chen, J.~H.~Hwang, and T.~Xie,
``Designing fast and scalable XACML policy evaluation engines,''
\emph{IEEE Trans.\ Computers}, vol.~60, no.~12, pp.~1802--1817, Dec.\ 2011, doi: 10.1109/TC.2010.274.

\bibitem{b16}
L.~Ma \emph{et~al.},
``Research on authorization model of attribute access control based
on knowledge graph,''
in \emph{Proc.\ UbiSec}, Springer, 2024, pp.~348--359, doi: 10.1007/978-981-97-1274-8\_23.

\bibitem{b17}
R.~Pang \emph{et~al.},
``Zanzibar: {Google's} consistent, global authorization system,''
in \emph{Proc.\ USENIX ATC}, 2019, pp.~33--46. [Online]. Available: \url{https://www.usenix.org/conference/atc19/presentation/pang}
...
\bibitem{b19}
M.~Rostamipoor, A.~Sadeghi, and M.~Polychronakis,
``KubeKeeper: Protecting {K}ubernetes secrets against excessive permissions,''
in \emph{Proc.\ 2025 IEEE Eur.\ Symp.\ Security and Privacy (EuroS\&P)}, 2025, pp.~322--338, doi: 10.1109/EuroSP63326.2025.00027.
